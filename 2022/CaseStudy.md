...
|
Dots represent samples of 16S rRNA gene amplicon sequencing projects. Click on one of the dots (1). On the right panel, taxonomic composition of the sample analyzed by VITCOMIC2 is displayed as a bar graph. Also, topic composition of that sample inferred by LEA is displayed on the panel (2). When you mouse over the topic's bar graph, the pictures of corresponding topic will be highlighted on the map (3).
